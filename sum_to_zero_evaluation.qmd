...
ozs_ppc = (p9.ggplot(obs_vs_rep_ozs_long, p9.aes(x='sim_data pos_tests', y='value')) +
    ...
    p9.labs(x='pos_tests (simulated)', y='Posterior estimates', title='Sum-to-zero vector\nPosterior Predictive Check') +
